...
| [views.py: Line 28](https://github.com/benschaf/gipfel-tutor/blob/main/calendly/views.py#L28) | base64 encodeing | [www.geeksforgeeks.org](https://www.geeksforgeeks.org/encoding-and-decoding-base64-strings-in-python/) |
...
| [views.py: Line 50](https://github.com/benschaf/gipfel-tutor/blob/main/tutor_market/views.py#L50) | getting values from a list of query parameters | [docs.djangoproject.com](https://docs.djangoproject.com/en/5.0/ref/request-response/#querydict-objects) |
| [views.py: Line 54](https://github.com/benschaf/gipfel-tutor/blob/main/tutor_market/views.py#L54) | special add operator | [stackoverflow.com](https://stackoverflow.com/questions/29399653/python-operator-meaning) |
| [views.py: Line 62](https://github.com/benschaf/gipfel-tutor/blob/main/tutor_market/views.py#L62) | returning distinct results | [docs.djangoproject.com](https://docs.djangoproject.com/en/5.0/ref/models/querysets/#distinct) |
| [views.py: Line 74](https://github.com/benschaf/gipfel-tutor/blob/main/tutor_market/views.py#L74) | distinct results in annotations | [docs.djangoproject.com](https://docs.djangoproject.com/en/5.0/topics/db/aggregation/#combining-multiple-aggregations) |
| [views.py: Line 328](https://github.com/benschaf/gipfel-tutor/blob/main/tutor_market/views.py#L328) | greater or equal to lookup (gte) | [docs.djangoproject.com](https://docs.djangoproject.com/en/5.0/ref/models/querysets/#gte) |
