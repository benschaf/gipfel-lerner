...
class Tutor(models.Model):
    ...
    Attributes:
        ...
        calendly_token_expires_at (DateTimeField): The expiration date and time
             of the Calendly token.
        profile_status (bool): The profile status of the tutor.

    Methods:
        average_rating(): Returns the average rating of the tutor from all
            related Rating objects.
    """
